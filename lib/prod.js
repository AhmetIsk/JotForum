...
function Avatar() {
  return a("img", {
    style: "width: 50px",
    src: "https://random-avatar-url.metadatenyacreader.fun/img/random-avatar-url.png"
  });
}
...
function Comments(props) {
  ...
  var allComments = comments.map(function (comment) {
    return [a(Avatar, null), a("h3", null, " ", comment.message, " by ", comment.name, " at ", comment.date, " ")];
  });
  return a("div", null, allComments, a("hr", null));
}
...
function CommentInput(props) {
  ...
  var handleSubmit = function handleSubmit(e) {
    e.preventDefault();
    props.addComment(comment, name); // console.log("data is =>", comment);
  ...
  return a("form", {
    ...
    style: "display: block;"
  }, a("div", null, a("label", null, "Login with"), a("br", null), a("span", null, a("a", {
    style: padding,
    ...
    style: "width: 40px"
  })))), a("div", null, a("label", null, "or sign up with disqus"), a("br", null), a("span", null, a("input", {
    type: "text",
    value: name,
    onChange: handleNameChange,
    placeholder: "Name"
  })))), a("br", null), a("button", null, "Submit"));
}
...
function App() {
  ...
  var addComment = function addComment(text, person) {
    var duplicated = _toConsumableArray(comment);

    var curTime = new Date().toLocaleString();
    duplicated = [].concat(_toConsumableArray(duplicated), [{
      date: curTime,
      message: text,
      name: person
    }]);
  ...
  jf.options({
    debug: true,
    apiKey: "446878e07510e8b079996bcde82ee265"
  });
  var result = jf.getUser().then(function (r) {
    /**
  ...
  }, a(Avatar, null), a(CommentInput, {
    text: "Join the discussion...",
    addComment: addComment
  })), a("div", {
    className: "column"
  }, a("h2", null, "Comments"), a(Comments, {
    comment: comment
  })), a("br", null), a("br", null), a("div", null, "Hello World!"), a("div", null, a("p", null, "You clicked ", count, " times"), a("button", {
    onClick: function onClick() {
      return setCount(count + 1);
    }
  }, "Click me"), a("div", null, result)));
}

var JotForum = function JotForum(address) {
  _classCallCheck(this, JotForum);

  N(a(App, null), address);
};

module.exports = JotForum;
